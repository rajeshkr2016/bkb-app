...
A dating app currently in the design/planning phase.

## Status

No source code yet — the repo contains architecture docs and use case specifications.
...
- [docs/testing.md](docs/testing.md) — Testing guide with test cases, multi-device testing, and DB verification
